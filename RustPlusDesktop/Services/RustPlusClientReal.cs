...
public sealed class ArkClientReal : IArkClient, IDisposable
{
    ...
    private readonly Dictionary<uint, ArkDuckBot.Models.StorageSnapshot> _storageCache
    = new Dictionary<uint, ArkDuckBot.Models.StorageSnapshot>();
    public bool TryGetCachedStorage(uint id, out ArkDuckBot.Models.StorageSnapshot snap)
...
""";
    ...
    private void Api_OnTeamChatReceived(object? sender, TeamMsgArg e)
    {
        try
        {

...
public class TrackingSettings
{
    ...
    public bool AnnounceDodo { get; set; } = false;
    public bool AnnounceReaper { get; set; } = false;
    public bool AnnounceMegalodon { get; set; } = false;
    public bool AnnounceSupplyDrop { get; set; } = false;
...
public static class TrackingService
{
    ...
    private static readonly string _dbPath = Path.Combine(
        ...
        "ArkDuckBot", "tracked_players.json");
    private static readonly string _settingsPath = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
        "ArkDuckBot", "tracking_settings.json");
    ...
    {
        _http.DefaultRequestHeaders.Add("User-Agent", "ArkDuckBot/1.0");
        LoadDB();
    }
    ...
    public static bool AnnounceDodo
    {
    ...
    public static bool AnnounceReaper
    {
        ...
        set { _settings.AnnounceReaper = value; SaveDB(); }
    }
    public static bool AnnounceMegalodon
    {
        get => _settings.AnnounceMegalodon;
        set { _settings.AnnounceMegalodon = value; SaveDB(); }
    }
    public static bool AnnounceSupplyDrop
    {
        get => _settings.AnnounceSupplyDrop;
        set { _settings.AnnounceSupplyDrop = value; SaveDB(); }
    }

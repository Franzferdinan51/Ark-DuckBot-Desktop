...
namespace ArkDuckBot.Services
{
    ...
    {
        private const string RepoOwner = "Franzferdinan51";
        private const string RepoName = "Ark-DuckBot-Desktop";
        private const string InstallerAssetName = "ArkDuckBot-Setup.exe";
